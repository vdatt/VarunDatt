...
public class AContent implements Serializable, Equals, HashCode
{
    ...
    public AContent withContent(Object... values) {
        if (values!= null) {
    ...
    public AContent withContent(Collection<Object> values) {
        if (values!= null) {
    ...
    public AContent withContent(List<Object> content) {
        setContent(content);
        return this;
    }
